                ...
                if (!isRunning) {
                    ...
                    new CountDownTimer(timeLimit, 1000) {
                        ...
                        public void onFinish() {
                            Toast.makeText(ViewExercise.this, "Отлично!", Toast.LENGTH_SHORT).show();
                            finish();
                    ...
                    Toast.makeText(ViewExercise.this, "Попробуйте еще раз", Toast.LENGTH_SHORT).show();
                    finish();
